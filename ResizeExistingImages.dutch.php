...
$txt['resize_images_batch_desc'] = 'Door het uitvoeren van deze onderhoudstaak worden <b>alle</b> bestaande afbeeldingen aangepast volgens de ingestelde opties (Niet-JPEG afbeeldingen naar JPEG, JPEG kwaliteit factor en/of maximale afbeelding breedte/hoogte) zoals ingesteld onder <i>Beheer -> Forum -> Bijlagen en Avatars -> Bijlage-instellingen</i>.<br/><br/>Om overbelasting van de server te voorkomen wordt het aantal afbeeldingen per bewerking ingesteld volgens de waarde bij <i>Beheer -> Forum -> Berichten en Topics -> Topicinstellingen -> Aantal berichten per pagina in een topicpagina</i>.';

$txt['resize_reformat_images'] = 'Aanpassen bestaande afbeeldingen';

$txt['resize_images_now'] = 'Aanpassen bestaande afbeeldingen';
$txt['resize_reformat_images_now'] = 'Pas afbeeldingen nu aan ';

$txt['resize_image_height'] = 'Afbeelding hoogte';
$txt['resize_image_width'] = 'Afbeelding breedte';
$txt['resize_image_jpeg_quality'] = 'JPEG kwaliteit';

$txt['resize_number_images'] = '<b>Aantal afbeeldingen om aan te passen : </b>';
$txt['resize_batch_size'] = '<b>Afbeeldingen worden aangepast in batches van : </b>';
...
$txt['resize_elapsed_time'] = '<b>Verstreken tijd : </b>';
$txt['resize_total_resized'] = '<b>Totaal aantal afbeeldingen aangepast : </b>';
$txt['resize_space_desc'] = 'De ruimte gebruikt door <b>alle</b> bijlagen voor en na de uitvoering van dit proces en de hoeveelheid bespaarde ruimte, is als volgt:';
$txt['resize_space_after'] = '<b>Bijlage ruimtebeslag na : </b>';
$txt['resize_space_before'] = '<b>Bijlage ruimtebeslag voor : </b>';
$txt['resize_space_saved'] = '<b>Gewonnen ruimte : </b>';
$txt['megabyte'] = ' Mb';
